...
export const slides: Slide[] = [
  ...
  },
  {
    type: "mindset",
    title: "새로운 시대의 업무 원칙",
    subtitle: "우리의 새로운 목표는 극단적이어야 합니다",
    description:
      "AI는 과거에는 불가능했던 수준의 효율을 현실로 만듭니다. 이제 우리의 목표는 '조금 더' 개선하는 것이 아니라, '0'과 '무한대'에 도전하는 것이 되어야 합니다. 이 세 가지 극단적인 지표를 우리의 새로운 업무 원칙이자, 측정 가능한 목표로 삼아야 합니다.",
    icon: BrainCircuit,
    points: [
      {
        metric: "0",
